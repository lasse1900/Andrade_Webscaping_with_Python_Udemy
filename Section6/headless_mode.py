...
# container = driver.find_element_by('adbl-impression-container ')
container = driver.find_element('adbl-impression-container ')
products = container.find_elements('.//li[contains(@class, "productListItem")]')
...
for product in products:
    ...
    title = product.find_element('.//h3[contains(@class, "bc-heading")]').text
    book_title.append(title)
    print(title)
    book_author.append(product.find_element('.//li[contains(@class, "authorLabel")]').text)
    book_length.append(product.find_element('.//li[contains(@class, "runtimeLabel")]').text)
